...
@AnalyzeClasses(packagesOf = HospitalSystemApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(HospitalSystemApp.class), alwaysTrue())
